...
import {
  toolsFontStylsItems,
  toolsColorStyleItems,
  toolsHeadingStyleItems,
  getLastStyleFontColor,
  getLastStyleBackgroundColor,
  setStyle,
  isStyleActive,
          ...
          activator={
            <div className="w-20 flex">
              {Object.keys(toolsHeadingStyleItems).map((item) => (
                <span
                  key={toolsHeadingStyleItems[item].value}
                  className={
                    (!!isStyleActive(
                      editorState,
                      toolsHeadingStyleItems[item].style,
                      toolsHeadingStyleItems[item].method
                    )
                      ? ""
                      : "hidden") + " text-sm"
                  }
        ...
        <div className="border-x border-gray-2 h-full flex items-center">
          <AppDropDownMenu
            ...
            activator={
              <div
                className={
                  toolsColorStyleItems[colorSelected].option.class.background +
                  " w-4 h-4 rounded"
                }
              ></div>
            }
              ...
              <div className="p-2 flex flex-col w-40">
                <div className="grid grid-cols-5 gap-1">
                  {Object.keys(toolsColorStyleItems).map((item, i) => (
                    <button
                      title={toolsColorStyleItems[item].title}
                      key={toolsColorStyleItems[item].value}
                      onClick={(e) =>
                        onBtnColorClick(e, toolsColorStyleItems[item])
                      }
                      className={
                        (!!isStyleActive(
                          editorState,
                          toolsColorStyleItems[item].option.style.color,
                          item.method
                        )
                          ? "ring ring-gray-2"
                          : "") +
                        " " +
                        toolsColorStyleItems[item].option.class.color +
                ...
                <div className="grid grid-cols-5 gap-1">
                  {Object.keys(toolsColorStyleItems).map((item, i) => (
                    <button
                      ...
                      key={toolsColorStyleItems[item].value}
                      onClick={(e) =>
                        onBtnBackgroundClick(e, toolsColorStyleItems[item])
                      }
                      className={
                        (!!isStyleActive(
                          editorState,
                          toolsColorStyleItems[item].option.style.background,
                          item.method
                        )
                          ? "ring ring-gray-2"
                          : "") +
                        ...
                        toolsColorStyleItems[item].option.class.color +
                        " " +
                        toolsColorStyleItems[item].option.class.background +
                        " size-6 rounded border border-gray-2 text-sm app-base-transform hover:bg-gray-2"
                      }
                    >
                      A
          ...
          {toolsFontStylsItems.map((item) => (
            <button
              ...
              className={
                ...
                (!!isStyleActive(editorState, item.style, item.method)
                  ? "bg-gray-2"
                  : "")
              }
            >
